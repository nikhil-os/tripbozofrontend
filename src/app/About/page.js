...
export default function AboutPage() {
  ...
  return (
    <main className="bg-gradient-to-br from-[#e0f7fa] via-[#f5fafd] to-[#e3f2fd] text-gray-800 w-full min-h-screen">
      {/* Hero Section */}
      <section className="w-full bg-gradient-to-r from-[#38bdf8] via-[#2ad2c9] to-[#5eead4] text-white py-8 sm:py-14 px-2 sm:px-4 flex flex-col items-center justify-center text-center relative overflow-hidden animate-fade-in rounded-2xl sm:rounded-3xl mx-auto my-2">
      ...
      {/* Mission Section */}
      <section className="w-full bg-[#f7fafc] py-7 sm:py-10 px-2 sm:px-4 flex flex-col items-center justify-center text-center animate-fade-in-up rounded-2xl sm:rounded-3xl mx-auto my-2 shadow-sm">
      ...
      <section className="w-full bg-white py-7 sm:py-10 px-2 sm:px-4 flex flex-col items-center justify-center animate-fade-in stagger-children rounded-2xl sm:rounded-3xl mx-auto my-2 shadow-sm border-t border-b border-[#e0e0e0]">
      ...
      {/* CTA Section */}
      <section className="w-full bg-gradient-to-r from-[#2ad2c9] via-[#38bdf8] to-[#5eead4] text-white py-8 sm:py-12 px-2 sm:px-4 flex flex-col items-center justify-center text-center animate-fade-in-up relative overflow-hidden rounded-2xl sm:rounded-3xl mx-auto my-2 shadow-sm">
