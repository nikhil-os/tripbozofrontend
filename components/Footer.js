...
const Footer = () => {
    return (
         <footer className="bg-gray-900 text-white pt-16 pb-16 min-h-[250px]  shadow-xl border-4 border-teal-200 w-full max-w-[1800px] mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-20 items-start text-left">
                ...
                {/* Quick Links - heading shifted even further right to align with Home button */}
            ...
            {/* Copyright and Legal */}
            <div className="border-t border-gray-700 mt-10 pt-6 text-left flex flex-col gap-2 sm:flex-row sm:justify-start">
                <p className="text-gray-300 text-sm">© 2025 TravelBuddy. All rights reserved.</p>
                <div className="mt-4 sm:mt-0">
                    <span className="text-gray-300 text-sm">
                        <AppLink className="hover:text-white transition-colors" href="/privacy">Privacy Policy</AppLink>
                        <span className="mx-2">•</span>
                        <AppLink className="hover:text-white transition-colors" href="/terms">Terms of Service</AppLink>
                    </span>
                </div>
            </div>
        </footer>
