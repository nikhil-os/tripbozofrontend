...
const Footer = () => {
    return (
         <footer className="bg-gray-900 text-white pt-16 pb-16 min-h-[250px] rounded-3xl shadow-xl border-4 border-teal-200 mx-auto my-12 w-full max-w-[1800px]">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 text-sm mb-4">Subscribe to our newsletter for travel tips and app recommendations.</p>
                        <form className="flex">
    <input
        type="email"
        placeholder="Your email"
        className="px-4 py-2 rounded-l-2xl w-full text-sm text-gray-900 focus:outline-4 bg-white focus:ring-2 focus:ring-teal-400"
    />
    <button
        type="submit"
        className="bg-teal-400 text-white px-4 py-2 rounded-r-2xl text-sm font-medium hover:bg-teal-500 transition-colors"
    >
        Subscribe
    </button>
</form>
                ...
                {/* Copyright and Legal */}
                <div className="border-t border-gray-700 mt-10 pt-6 text-center sm:flex sm:justify-between">
